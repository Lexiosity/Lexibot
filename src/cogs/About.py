...
class About(commands.Cog):
  ...
  # Defines what !about would do.
    ...
    async def about(self, ctx):
        ...
        embed1.add_field(name="How is LinkBot made?", value="I was made with python, using Discord.py! I was also created by LinkexaHy. My source code will be found at [LinkBot](https://github.com/LinkexaHy/LinkBot/).")
